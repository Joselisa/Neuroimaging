...
for subjdir in *;
 do
	...
	echo Flirt ok!;
	fnirt --in=/Users/INCE/Documents/Bedpostx/${subjdir}/nodif_brain --aff=/Users/INCE/Documents/Bedpostx/${subjdir}/xfms/diff2standard.mat --ref=/usr/local/fsl/data/standard/FMRIB58_FA_1mm.nii.gz --cout=/Users/INCE/Documents/Bedpostx/${subjdir}/xfms/diff2standard_warp
	echo FNIRT ok!;
	...
	invwarp -w /Users/INCE/Documents/Bedpostx/${subjdir}/xfms/diff2standard_warp -o /Users/INCE/Documents/Bedpostx/${subjdir}/xfms/standard2diff_warp -r /usr/local/fsl/data/standard/FMRIB58_FA_1mm.nii.gz
